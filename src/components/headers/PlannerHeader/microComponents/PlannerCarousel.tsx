...
import { LARGE_MARGIN, PLANNER_CAROUSEL_ICON_WIDTH, SMALL_MARGIN } from "@/lib/constants/miscLayout";
...
const PlannerCarousel = ({ datestamp: currentDatestamp }: TPlannerPageParams) => {
    ...
    return (
        <Animated.View style={headerStyle}>
            <Host style={{ height: 22 + PLANNER_CAROUSEL_ICON_WIDTH + SMALL_MARGIN * 2, width: '100%' }}>
