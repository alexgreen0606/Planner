...
const UpcomingDatesHeader = () => {
    ...
    const calendars = useMemo(() => {
        return Object.values(calendarMap)
            ...
            .sort((a, b) =>
                a.id === primaryCalendar?.id ? -1 :
                    b.id === primaryCalendar?.id ? 1 : 0
            );
        ...
        >
            ...
            <View>
                ...
                <ShadowView edgeSize={{ right: 200 }}>
                    ...
                    {/* Header */}
                    <MotiText style={textStyles['upcomingDatesHeader']} animate={{
                        // @ts-ignore
                ...
                {/* Subheader */}
                <MotiView className="overflow-hidden" animate={{
                    height: collapseHeader ? 0 : 20
                }}>
                    <CustomText variant='upcomingDatesSubHeader'>
            ...
            <PopupList
                ...
                actions={calendars.map((calendar) => ({
                    ...
                    color: handleGetIsCalendarActive(calendar.id) ? calendar.color : hexToRgba(calendar.color),
