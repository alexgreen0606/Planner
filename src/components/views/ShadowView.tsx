      ...
      {width > 0 && height > 0 && (
        ...
        >
          <Svg width={totalWidth} height={totalHeight} style={StyleSheet.absoluteFillObject}>
            ...
            {/* Top-left corner */}
            <Rect x={0} y={0} width={edges.left} height={edges.top} fill="url(#topLeftCorner)" />

            {/* Top edge */}
            <Rect x={edges.left} y={0} width={width} height={edges.top} fill="url(#topEdge)" />
            ...
            {/* Left edge */}
            <Rect x={0} y={edges.top} width={edges.left} height={height} fill="url(#leftEdge)" />
