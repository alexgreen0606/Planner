...
export type TInitialEventMetadata =
    | { eventType: EEventType.NON_CALENDAR; plannerEvent: IPlannerEvent, planner: TPlanner }
    | { eventType: EEventType.CALENDAR_SINGLE_DAY; plannerEvent: IPlannerEvent, planner: TPlanner }
    | { eventType: EEventType.CALENDAR_ALL_DAY; calendarEvent: Calendar.Event }
    | {
        eventType: EEventType.CALENDAR_MULTI_DAY;
        startPlannerEvent: IPlannerEvent | null,
        startPlanner: TPlanner | null,
        endPlannerEvent: IPlannerEvent | null,
